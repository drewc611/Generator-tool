...
![node --test running the portamp suite: 843 passing, 844 tests, 0 failing, 1 skipped, grouped by the core staying framework blind, nine targets on one IR, the countable claims, and the newest plugins, from the transformer and the learned archetype model to the Ember, Mithril, Marko, Liquid, Twig and XSLT readers](media/test-run.png)

<sub>Proof, not a promise. Every line above is verbatim from `npm test`: 843
...
| Tests | 11,847 lines, 844 cases across 111 files |
...
The core grew from 527 lines to 718 across five hundred and ninety nine features, and every
...
The whole picture is [ROADMAP.md](ROADMAP.md): five hundred and ninety nine features in
one hundred and fifteen phases, forty four shipped, five hundred and fifty two new in the
