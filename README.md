...
lines of core, no runtime dependencies, 117 plugins, and the literal output of
`npm run demo`.</sub>
...
node src/cli.js plugins      # 117 plugin(s)
...
| Every line of the tool | 24,596 lines of JavaScript |
| Tests | 7,294 lines, 571 cases |
...
![The plugin rack: 117 plugins listed by class, with what each one does](media/plugin-rack.svg)
