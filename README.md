...
node src/cli.js plugins      # 204 plugin(s)
...
| Every line of the tool | 54,024 lines of JavaScript in src and plugins |
| Tests | 19,402 lines, 1127 cases across 152 files |
...
The core grew from 527 lines to 718 across six hundred and sixty three features, and every
...
## The 204 it ships with

![The plugin rack: 204 plugins listed by class, with what each one does](media/plugin-rack.svg)
...
The whole picture is [ROADMAP.md](ROADMAP.md): six hundred and sixty three features in
one hundred and sixty six phases, forty four shipped, six hundred and sixteen new in the
