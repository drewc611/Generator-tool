...
lines of core, no runtime dependencies, 115 plugins, and the literal output of
`npm run demo`.</sub>
...
node src/cli.js plugins      # 115 plugin(s)
...
| Every line of the tool | 24,315 lines of JavaScript |
| Tests | 7,232 lines, 568 cases |
...
![The plugin rack: 115 plugins listed by class, with what each one does](media/plugin-rack.svg)
