...
![node --test running the portamp suite: 937 passing, 939 tests, 0 failing, 1 skipped, grouped by the core staying framework blind, nine targets on one IR, the countable claims, and the newest plugins, from the transformer and the learned archetype model to the Ember, Mithril, Marko, Liquid, Twig and XSLT readers](media/test-run.png)
...
npm test                     # 939 tests, node --test, no framework
```
...
| Tests | 13,848 lines, 939 cases across 126 files |
...
The core grew from 527 lines to 718 across six hundred and twenty nine features, and every
...
The whole picture is [ROADMAP.md](ROADMAP.md): six hundred and twenty nine features in
one hundred and forty four phases, forty four shipped, five hundred and eighty two new in the
