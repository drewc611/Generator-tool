...
npm test                     # 832 tests, node --test, no framework
```
...
| Every line of the tool | 36,935 lines of JavaScript in src and plugins |
| Tests | 11,690 lines, 832 cases across 109 files |
...
The core grew from 527 lines to 718 across five hundred and ninety six features, and every
...
The whole picture is [ROADMAP.md](ROADMAP.md): five hundred and ninety six features in
one hundred and twelve phases, forty four shipped, five hundred and forty nine new in the
