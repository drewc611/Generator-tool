...
![node --test running the portamp suite: 823 passing, 824 tests, 0 failing, 1 skipped, grouped by the core staying framework blind, nine targets on one IR, the countable claims, and the newest plugins, from the transformer and the learned archetype model to the Ember, Mithril, Marko, Liquid, Twig and XSLT readers](media/test-run.png)

<sub>Proof, not a promise. Every line above is verbatim from `npm test`: 823
...
npm test                     # 824 tests, node --test, no framework
```
...
| Every line of the tool | 36,570 lines of JavaScript in src and plugins |
| Tests | 11,582 lines, 824 cases across 108 files |
...
The core grew from 527 lines to 718 across five hundred and ninety four features, and every
...
The whole picture is [ROADMAP.md](ROADMAP.md): five hundred and ninety four features in
one hundred and ten phases, forty four shipped, five hundred and forty seven new in the
