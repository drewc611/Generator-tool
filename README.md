...
node src/cli.js plugins      # 165 plugin(s)
npm run demo                 # runs the pipeline against example/legacy
npm test                     # 802 tests, node --test, no framework
```
...
| Every line of the tool | 35,537 lines of JavaScript in src and plugins |
| Tests | 11,158 lines, 802 cases across 102 files |
...
## The 165 it ships with

![The plugin rack: 165 plugins listed by class, with what each one does](media/plugin-rack.svg)
