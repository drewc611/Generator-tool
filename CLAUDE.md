...
Plugins that ship, a hundred and twenty one in five classes, and the core has never learned
...
input    input-angular  input-angularjs  input-vue  input-knockout
         ...
         input-blackbox  input-polymer  input-riot  input-react  input-svelte
dsp      dsp-ir  dsp-tokens  dsp-apimap  dsp-behavior  dsp-improve
         ...
         dsp-apistyle  dsp-auth  dsp-duplication  dsp-state  dsp-weight  dsp-seo  dsp-analytics  dsp-images  dsp-fonts  dsp-security  dsp-supplychain  dsp-console  dsp-globals  dsp-landmarks  dsp-labels  dsp-render-blocking  dsp-inline  dsp-learn
