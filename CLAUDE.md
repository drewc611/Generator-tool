...
Plugins that ship, a hundred and sixty in five classes, and the core has never learned
...
input    input-alpine  input-angular  input-angularjs  input-vue  input-knockout
         ...
         input-blackbox  input-polymer  input-riot  input-react  input-svelte  input-lit  input-stencil  input-webcomponents  input-ember  input-mithril  input-marko
