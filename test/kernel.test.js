...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "input-alpine", "input-angular", "input-angularjs", "input-asar", "input-aspnet", "input-backbone", "input-birt", "input-blackbox", "input-blade", "input-cfml", "input-cics", "input-delphi", "input-django", "input-ejs", "input-ember", "input-exe", "input-explore", "input-extjs", "input-fbp", "input-fetch", "input-flex", "input-freemarker", "input-fxml", "input-glade", "input-gwt", "input-haml",
    "input-handlebars", "input-informix", "input-jasperreports", "input-jinja", "input-jquery", "input-jsf", "input-jsp", "input-knockout",
