...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "dsp-deadcode", "dsp-diff", "dsp-duplication", "dsp-entities", "dsp-entropy", "dsp-era", "dsp-events", "dsp-flags", "dsp-fonts", "dsp-forms", "dsp-globals",
    "dsp-i18n", "dsp-images", "dsp-imports", "dsp-improve", "dsp-inline",
    "dsp-ir", "dsp-labels", "dsp-landmarks", "dsp-learn", "dsp-magic", "dsp-modernize", "dsp-motion", "dsp-observers", "dsp-perf", "dsp-permissions", "dsp-print", "dsp-props", "dsp-render-blocking", "dsp-routes", "dsp-security", "dsp-seo", "dsp-state", "dsp-storage", "dsp-supplychain", "dsp-timers", "dsp-tokens",
    ...
    "output-tests", "output-types", "output-vercel", "output-vue", "vis-coverage", "vis-equivalence", "vis-graph", "vis-parity", "vis-roundtrip", "vis-timeline", "vis-transformer", "vis-ui",
  ]);
