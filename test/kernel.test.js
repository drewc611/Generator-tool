...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "input-alpine", "input-angular", "input-angularjs", "input-asar", "input-aspnet", "input-backbone", "input-blackbox", "input-blade", "input-cfml", "input-delphi", "input-django", "input-ejs", "input-ember", "input-exe", "input-explore", "input-fetch", "input-freemarker", "input-haml",
