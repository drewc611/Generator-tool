...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "input-alpine", "input-angular", "input-angularjs", "input-aspnet", "input-backbone", "input-blackbox", "input-blade", "input-cfml", "input-django", "input-ejs", "input-ember", "input-exe", "input-explore", "input-fetch", "input-freemarker", "input-haml",
    "input-handlebars", "input-jinja", "input-jquery", "input-jsf", "input-jsp", "input-knockout",
    "input-liquid", "input-lit", "input-marko", "input-mithril", "input-openapi", "input-pdf", "input-pebble", "input-polymer", "input-pug", "input-razor", "input-react", "input-record", "input-riot", "input-shots", "input-slim", "input-smarty", "input-static", "input-stencil", "input-svelte", "input-thymeleaf", "input-twig", "input-twirl", "input-underscore", "input-velocity", "input-volt", "input-vue", "input-webcomponents", "input-xslt",
