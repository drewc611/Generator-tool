...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "input-liquid", "input-lit", "input-marko", "input-mithril", "input-openapi", "input-pdf", "input-pebble", "input-photo", "input-polymer", "input-pug", "input-qt", "input-razor", "input-rc", "input-react", "input-record", "input-riot", "input-shots", "input-slim", "input-smarty", "input-static", "input-stencil", "input-storyboard", "input-svelte", "input-swing", "input-tapestry", "input-thymeleaf", "input-twig", "input-twirl", "input-underscore", "input-uno", "input-vb6", "input-velocity", "input-volt", "input-vue", "input-webcomponents", "input-winforms", "input-xaml", "input-xslt",
