...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "output-adr", "output-alpine", "output-angular", "output-astro", "output-aws", "output-azure", "output-cem", "output-ci", "output-codemod", "output-curl", "output-cypress",
    ...
    "output-tests", "output-types", "output-vue", "vis-coverage", "vis-equivalence", "vis-graph", "vis-parity", "vis-roundtrip", "vis-timeline", "vis-transformer", "vis-ui",
  ]);
