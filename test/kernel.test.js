...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "general-agent", "general-agents", "general-architect", "general-authorization", "general-doctor", "general-history", "general-license", "general-policy", "general-publish", "general-scaffold", "general-scrape", "general-search", "general-size", "general-study", "general-watch",
    "input-alpine", "input-angular", "input-angularjs", "input-asar", "input-aspnet", "input-autoit", "input-awt", "input-backbone", "input-birt", "input-blackbox", "input-blade", "input-cfml", "input-cics", "input-cobolscreen", "input-delphi", "input-django", "input-ejs", "input-ember", "input-exe", "input-explore", "input-extjs", "input-fbp", "input-fetch", "input-flex", "input-fluid", "input-freemarker", "input-fxml", "input-glade", "input-gwt", "input-haml",
    "input-handlebars", "input-informix", "input-ispf", "input-jasperreports", "input-jinja", "input-jquery", "input-jsf", "input-jsp", "input-knockout",
    "input-liquid", "input-lit", "input-marko", "input-mithril", "input-netbeansform", "input-openapi", "input-openedge", "input-pbwin", "input-pdf", "input-pebble", "input-photo", "input-polymer", "input-powerbuilder", "input-pug", "input-qt", "input-razor", "input-rc", "input-react", "input-record", "input-riot", "input-shots", "input-slim", "input-smarty", "input-ssrs", "input-static", "input-stencil", "input-storyboard", "input-svelte", "input-swing", "input-tapestry", "input-thymeleaf", "input-tk", "input-twig", "input-twirl", "input-uikit", "input-underscore", "input-uno", "input-vb6", "input-velocity", "input-volt", "input-vue", "input-webcomponents", "input-winforms", "input-xaml", "input-xbase", "input-xslt",
    "output-adr", "output-alpine", "output-angular", "output-astro", "output-aws", "output-azure", "output-backend", "output-caddy", "output-cem", "output-ci", "output-cloudflare", "output-codemod", "output-curl", "output-cypress",
