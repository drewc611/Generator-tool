...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "dsp-ir", "dsp-labels", "dsp-landmarks", "dsp-modernize", "dsp-motion", "dsp-perf", "dsp-permissions", "dsp-print", "dsp-props", "dsp-routes", "dsp-security", "dsp-seo", "dsp-state", "dsp-supplychain", "dsp-tokens",
