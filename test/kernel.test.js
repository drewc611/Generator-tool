...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "input-liquid", "input-lit", "input-marko", "input-mithril", "input-openapi", "input-pdf", "input-polymer", "input-razor", "input-react", "input-record", "input-riot", "input-shots", "input-static", "input-stencil", "input-svelte", "input-twig", "input-underscore", "input-velocity", "input-vue", "input-webcomponents", "input-xslt",
