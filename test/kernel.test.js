...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "input-alpine", "input-angular", "input-angularjs", "input-asar", "input-aspnet", "input-backbone", "input-birt", "input-blackbox", "input-blade", "input-cfml", "input-delphi", "input-django", "input-ejs", "input-ember", "input-exe", "input-explore", "input-extjs", "input-fbp", "input-fetch", "input-flex", "input-freemarker", "input-glade", "input-gwt", "input-haml",
    "input-handlebars", "input-jasperreports", "input-jinja", "input-jquery", "input-jsf", "input-jsp", "input-knockout",
    "input-liquid", "input-lit", "input-marko", "input-mithril", "input-openapi", "input-pdf", "input-pebble", "input-photo", "input-polymer", "input-powerbuilder", "input-pug", "input-qt", "input-razor", "input-rc", "input-react", "input-record", "input-riot", "input-shots", "input-slim", "input-smarty", "input-ssrs", "input-static", "input-stencil", "input-storyboard", "input-svelte", "input-swing", "input-tapestry", "input-thymeleaf", "input-twig", "input-twirl", "input-underscore", "input-uno", "input-vb6", "input-velocity", "input-volt", "input-vue", "input-webcomponents", "input-winforms", "input-xaml", "input-xslt",
