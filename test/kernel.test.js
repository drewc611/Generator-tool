...
test("discovery loads every plugin that ships", async () => {
  ...
  assert.deepEqual(names, [
    ...
    "output-tests", "output-types", "output-vercel", "output-vue", "vis-a11y", "vis-coverage", "vis-equivalence", "vis-graph", "vis-parity", "vis-roundtrip", "vis-timeline", "vis-transformer", "vis-ui",
  ]);
