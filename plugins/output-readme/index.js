...
const DESCRIBES = [
  ...
  [/^PALETTE\.md$/, "the colours each PNG screenshot is made of, counted from its pixels with their shares"],
  ...
  [/^FORMS_VB6\.md$/, "every Visual Basic 6 form's controls, menus, message strings and the frx it could not read"],
